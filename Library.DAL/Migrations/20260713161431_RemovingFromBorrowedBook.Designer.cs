...
namespace Library.DAL.Migrations
{
    ...
    [Migration("20260713161431_RemovingFromBorrowedBook")]
    partial class RemovingFromBorrowedBook
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Shared.Abstractions.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.DAL.Models.Librarian", b =>
                {
                    b.HasBaseType("Library.Shared.Abstractions.User");
            ...
            modelBuilder.Entity("Library.DAL.Models.Reader", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "Reader",
                            Password = "1234",
                            Birthday = new DateTime(2026, 7, 13, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("Library.DAL.Models.Librarian", b =>
                {
                    b.HasOne("Library.Shared.Abstractions.User", null)
                        .WithOne()
